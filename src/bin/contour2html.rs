...
use fluffy::svg::{EmbedOptions, embed_html_of_svg_path_with_fourier, html_of_svg_path_with_fourier, svg_path_of_contour};
...
fn main() {
    ...
    let embed_html = embed_html_of_svg_path_with_fourier(&svg_path, &contour.points, Some(&fd), &EmbedOptions::default());
